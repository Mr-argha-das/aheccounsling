...
.copy-upi-id-save input:nth-child(2){
...
<div class="modal fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
 <div class="modal-dialog modal-lg" id="modle-css-sthe">
  ...
  <div class="modal-body py-0" id="model-body-scs">
   <!-- <img src="webassets/images/logo.png" id="form_Style-logo" class="img-fluid" width="200"> -->
   ...
   <div class="container-fluid">
    <div class="">
        ...
        <div class="card">
            ...
            <form id="msform" class="mt-0" action="query/saveQueryModal" method="post" enctype="multipart/form-data">
             {{ csrf_field() }}
             <!-- progressbar -->
                    ...
                    <div class="">
                      ...
                      <div class="col-md-12">
                         <div class="row align-items-center">
                             <div class="col-lg-3 col-3 py-1 pr-0" id="padding-right-style">
                       ...
                       <div class="col-lg-9 col-9 py-1 pl-0" id="padding-left-style">
                          <input id="modal_en_mobile" name="modal_en_mobile" type="text" name="en_first_name" class="form-control form-control-sm error" placeholder="Number"  data-error="Name is required." spellcheck="true" autocomplete="off" aria-invalid="true" style="margin-bottom: -4px!important;">
                      </div>
                  </div>
              </div>
          ...
          <div class="col-lg-3 col-12 py-1">
                                          ...
                                          <div class="col-lg-12">
                                            <div class="account-details">
                                              <div class="table-account"> 
                                                ...
                                                <tr>
                                                    <td>A2G VENTURES PRIVATE LIMITED</td>
             ...
             <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
              <div class="panel-body">
                  ...
                  <div class="row">
                   <div class="col-lg-12">
                    <div class="account-details">
                      <div class="table-account img-style_csss_sth">
                        <img src="webassets/images/sc-code.png" alt="upi-scane">
                    </div>

                    <div class="user_upi-card-sho">
                        <p>A2G VENTURES PRIVATE LIMITED</p>
                    </div>
                    <div class="copy-upi-id-save">
                     <input type="text" value="Q069064858@ybl" id="myInput">
                     <input type="button" value="copy" onclick="myFunction()">
                 </div>
             </div>
         </div>
...
<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
  <div class="panel-body">
    ...
    <!-- <center><p class="btn btn-warning"></p></center> -->
