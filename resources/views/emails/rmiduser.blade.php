...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #fbfbfb;color: #000000">
   ...
   <strong>Name:-    {{ $booking_user_name }} </strong> <br>
   <strong>Email:-   {{ $booking_user_email }}</strong> <br>
   <strong>Phone:-   {{ $booking_user_phone }}</strong> <br>
   <strong>Assigment Type:- {{ $subject }}</strong> <br>
   <strong>Subject:- {{ $booking_user_subject }}</strong> <br>
   <strong>Message:- {{ $booking_user_message }}</strong> <br>
   <strong>Client Mail Subject:- {{ $user_mail_subject }}</strong> <br>
          ...
          <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <h1 class="v-font-size" style="margin: 0px; color: #274495; line-height: 210%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 38px;">
               <a href="https://www.ahecounselling.com/confirmorder/{{$table_id}}"> <strong> Send Approval E-mail</strong></a>
