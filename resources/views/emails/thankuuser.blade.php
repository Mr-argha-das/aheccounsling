...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 160%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;"><strong><span style="font-size: 20px; line-height: 32px; font-family: 'Open Sans', sans-serif;">{{ $username }},</span></strong></p>
...
Your {{ $payment_type }} to your order has been confirmed. Thank you for booking your order with us.
 </p>

 <p style="font-size: 14px; line-height: 160%;">&nbsp;</p>

<p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px; font-family: 'Open Sans', sans-serif;">
 <span style="font-size: 20px; line-height: 32px; font-family: 'Open Sans', sans-serif;"> Order Id :- <strong>{{$order_number}}</strong> </span> <br> 
 <span style="font-size: 20px; line-height: 32px; font-family: 'Open Sans', sans-serif;"> Assigment Type : <strong>{{$title}} </strong></span> <br> 
 <span style="font-size: 20px; line-height: 32px; font-family: 'Open Sans', sans-serif;">Order Title :   <strong>{{$subject}}</strong></span> 
