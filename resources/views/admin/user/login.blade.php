...
<head>
    ...
    <title>{{ $commonModel->pConfig->PanelName }}</title>
    ...
    <meta name="application-name" content="{{ $commonModel->pConfig->PanelName }}">
...
<i class="fa fa-sign-in-alt"></i>
                                    ...
                                    <div class="block-content" style="width:400px;">
                                        <div class="p-sm-3 px-lg-4 pb-lg-5 pt-lg-0 text-center">
                                            ...
                                            <form method="POST" action="{{ route('wpanelCheckLogin') }}">
                                                @csrf
                                                @if (Session::has('errorFlash'))

                                                <strong class="text-danger">{!! Session::get('errorFlash') !!}</strong>
...
-->
                                                    <!--   <div class="col-md-12">
                                                        ...
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $errors->first('session_nm') }}</strong>
                                                        </span>
                                                        @endif
                                                    </div> -->
                                                 ...
                                                 <!--    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input id="email" type="email" class="rounded-0 form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required placeholder="Username">
...
-->
                                                    <div class="col-md-12">
                                                        <input id="password" type="password" class="rounded-0 form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="Password">
