            ...
            <div class="flex-sm-fill">
                ...
                <div class="flex-sm-00-auto mt-3 mt-sm-0 ml-sm-3">
                    <span class="d-inline-block js-appear-enabled animated fadeIn" data-toggle="appear" data-timeout="350">
                        <a class="btn btn-primary fancyboxajax" href="{{url('admin/entry/myclientorders/'.$workDetails->en_id.'/edit')}}"><i class="fa fa-plus mr-1"></i>Update Status</a>
...
<div class="timeline">
  ...
  <div class="events">
    ...
    @foreach($workStatus as $statusValue)
    <div class="event">
      <div class="knob"><span>{{date('d-M-Y',strtotime($statusValue->created_at))}}</span></div>
      <div class="box">
          <div class="date border-bottom border-light p-2 mb-2">
        <h6>{{$orderStatus[$statusValue->status]}} - {{$statusValue->user_type}}</h6>

         <span class="text-light">
          {{date('h:i:s a',strtotime($statusValue->created_at))}}
         </span>
       <!--  <span>
