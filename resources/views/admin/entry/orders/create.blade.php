...
<div class="row">
         ...
         <div class="col-md-6" >
           ...
           <select   id="client_list" name="user_email" class="form-control form-control-lg"> 
               ...
               <option  value="{{$client->user_email}}">{{$client->user_name}}  ({{$client->user_password}})</option>
               @endforeach
          </select> 
       </div>
       ...
       <div class="col-md-6">
        ...
        <div class="col-md-6">
           ...
           <input type="text" name="deadline" class="form-control form-control-lg" id="deadline" readonly value ="{{date('d-M-Y')}}"  placeholder="">
        </div>
               ...
               <label class="control-label">Currency</label>
                <select  name="currency_type" id="currency_type"  class="form-control form-control-lg"> 
                      <option value="">Service Type</option>
                        ...
                        <option value="{{ $currency->currency_id }}">{{$currency->currency_code}}({{$currency->currency_symbol}})</option>
                        @endforeach
                   </select>
         </div>
