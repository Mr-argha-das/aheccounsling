...
<div class="row">
       ...
       <div class="col-md-12 ">
       {{ Form::bsSelect('project_categroy_id',$category,$row->project_categroy_id,['label'=>'Project-Category','class'=>'form-control']) }}
       </div>

       <input type="hidden" name="project_categroy_id_old" value="{{ $row->project_categroy_id }}">
       ...
       <div class="col-md-12 ">
           {{ Form::bsText('no_of_page',$row->no_of_page,['label'=>'No of Page','class'=>'form-control']) }}
       </div>

       <div class="col-md-12 ">
           {{ Form::bsText('word_count',$row->word_count,['label'=>'Word Count','class'=>'form-control']) }}
       </div>
       ...
       <div class="dropzone upload-widget" data-max-width="3000" data-max-height="3000" <?=$thub_img?>  data-upload-filekey="userfile">
          ...
          <div class="dropzone upload-widget" data-max-width="3000" data-max-height="3000" <?=$img_2?>  data-upload-filekey="userfile">
                ...
                <div class="col-md-6">
                  ...
                  <label><a href="{{ $row->url }}" download>Download Old file </a></label>
               </div>
