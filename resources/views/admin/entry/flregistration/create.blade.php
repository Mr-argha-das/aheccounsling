...
{{ Form::open(array('url' => $formAction,'data-ajaxAction'=>'../'.$formAction,'id'=>"fl_registration")) }}
<?php
...
<div class="row">
         ...
         <div class="col-md-6">
           {{ Form::bsText('fl_name','',['label'=>'Full Name','class'=>'form-control']) }}
       </div>
        <div class="col-md-6">
           {{ Form::bsText('fl_email','',['label'=>'Email','class'=>'form-control']) }}
       </div>
       ...
       <div class="col-md-6">
           {{ Form::bsText('fl_mobile','',['label'=>'Mobile','class'=>'form-control']) }}
       </div>

       <div class="col-md-6">
           {{ Form::bsText('fl_alternate_number','',['label'=>'Alternate Contact Number','class'=>'form-control']) }}
       </div>

       <div class="col-md-6">
           {{ Form::bsText('aadhar_number','',['label'=>'Aadhar Number','class'=>'form-control']) }}
       </div>

       <div class="col-md-6">
           {{ Form::bsText('pan_number','',['label'=>'Pan Number','class'=>'form-control']) }}
       </div>

        <div class="col-md-6">
           {{ Form::bsText('fl_address','',['label'=>'Address','class'=>'form-control']) }}
       </div>

       <div class="col-md-6">
           {{ Form::bsText('bank_name','',['label'=>'Bank Name','class'=>'form-control']) }}
       </div>

       <div class="col-md-6">
           {{ Form::bsText('bank_no','',['label'=>'Account Number','class'=>'form-control']) }}
       </div>

       <div class="col-md-6">
           {{ Form::bsText('bank_ifsc','',['label'=>'Bank IFSC Code','class'=>'form-control']) }}
       </div>
       <div class="col-md-6">
           {{ Form::bsText('bank_branch','',['label'=>'Bank Branch','class'=>'form-control']) }}
       </div>
      <div class="col-md-12 ">
        {{ Form::bsSubmit() }}
      </div>
