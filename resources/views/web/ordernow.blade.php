        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="col-md-6 my-2">
                  ...
                  <input id="modal_en_first_name" <?php if(!empty($first_name)) {?>readonly <?php } ?> value="{{$first_name}}" name="modal_en_first_name" type="text" required>
                  <span for="modal_en_first_name" class="d-inline-block">First Name</span>
              </div>
              </div>
              <div class="col-md-6 my-2">
                <div class="input-container">
                  <input id="modal_en_last_name" <?php if(!empty($last_name)) {?>readonly <?php } ?> name="modal_en_last_name" value="{{$last_name}}" type="text"  placeholder=""  data-error="Name is required." spellcheck="true" autocomplete="off" aria-invalid="true">
                  <span for="modal_en_last_name" class="d-inline-block">Last Name</span>
              </div>
          </div>
              <div class="col-md-12 my-2">
                <div class="input-container">
                  <input id="modal_en_email" <?php if(!empty($user_email)) {?>readonly <?php } ?> name="modal_en_email" type="text"  value="{{$user_email}}" placeholder=""  data-error="Name is required." spellcheck="true" autocomplete="off" aria-invalid="true" required>
                ...
                <div class="row my-2 mx-0 border">
                    <div class="col-2 px-0">
                        ...
                        <select  class="border-0" style="width: 60px;" name="country_code"  <?php if(!empty($phone_code)) {?> readonly <?php } ?> id="country_code" >
                         ...
                         <option <?php if($vs==91 || $vs==$phone_code) echo 'selected' ?>  value="{{$vs }}">+{{ $vs}} </option>
                         @endforeach 
                     </select>
                 </div>
                 <div class="col-10 pl-0">

                    <input type="number" class="border-0" <?php if(!empty($mobile)) {?>readonly <?php } ?>  id="modal_en_mobile" value="{{$mobile}}" name="modal_en_mobile"  placeholder="Mobile No." />
                </div>
            </div>
        </div>
        <div class="col-md-6 my-2">
    ...
    <div class="form-card mx-2 row">
        ...
        <div class="col-md-6 my-2">
                  ...
                  <select    name="rm_id" id="rm_id_check_value"  required > 
                    ...
                    <option <?php if($rm_id!='') echo 'selected'; ?> value="{{$rm_id}}">{{ $rmusername }}</option>
