                        ...
                        <div class="price-table-box1  price_bgbox_2 pricing-card">
                    	  ...
                    	  <?php  } ?> 
                            ...
                            <div class="price-table-inner">                             
                                <div class="price_report_writing">{{ Str::limit($service->services_name, 22) }}</div>
                                <div class="price_table_pages">
                                    <img src="<?=asset('/assets/uploads/services/'.$service->services_image)?>" height="120" width="200" alt="{{$service->image_alt}}">
                                    <h6><i class="bi bi-currency-dollar"></i><span class="price-text">{{ $service->amount.'/'.$service->type }}</span></h6>
                                </div>
                               ...
                               <div class="text-center"> <a href="{{$whatsAppLink}}"><button class="bg-success text-white pricing-button mt-2">Enquiry Now</button></a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach 
