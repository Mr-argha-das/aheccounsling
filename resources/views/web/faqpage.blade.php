      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-8 mb-lg-0 text-white">
            ...
            <h2 class="mt-3 mb-0">Frequently Asks Questions on {{ $faqcategory->title }}</h2>
        ...
        <div class="col-lg-8 col-md-8 mt-6 mt-md-0">
         ...
         <ul>
           ...
           <li class="question" id="question"><div class="expand-bar"></div>Q{{$key+1}}: {{$value}}?</li>

           <li class="answer">Ans: {{$answers[$key]}}.</li>
