      ...
      <div class="px-4 py-7 rounded hover-translate text-center shadow serv-contain">
        ...
        <div class="">
          <div class="ih-item square effect6 from_top_and_bottom"><a href="<?=route('servicespage', str_replace(" ","-",strtolower($service->services_name)))?>">
            ...
            <div class="img">
              <img src="<?=asset('/assets/uploads/services/'.$service->services_image)?>" alt="{{$service->image_alt}}" class="service-img">
          ...
          <div class="overlay"></div>
              <div class="serv-button p-1">
                <a href="Javascript:void(0)" class="serv-hover-btn">${{$service->amount}} </a>
                <a href="https://www.ahecounselling.com/contact-us" class="serv-hover-btn"> Book Now </a>
                <a href="{{$whatsAppLink}}" class="serv-hover-btn"> <img src="webassets/images/whatsapp.png" alt="Whatsapp" class="wp-icon-btn"/></a>
              </div>
              </div>
        </div>
