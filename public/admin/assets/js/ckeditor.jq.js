...
//settings.removeFormatAttributes = '';
$( 'textarea.ckeditor' ).ckeditor(settings);
$( 'textarea.ckeditor-basic' ).ckeditor(settings_basic);

if($( 'textarea.ckeditor,textarea.ckeditor-basic' ).closest('#fancybox-content')){
...
/*
$( 'textarea.editorinline' ).ckeditor({
creator: inline}
);*/
