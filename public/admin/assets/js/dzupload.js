        ...
        callback: function (value) {
            ...
            if (value) {
                ...
                $.ajax({
                    ...
                    data: "file=" + DelteFile + "&&path=" + FileFolder+ "&&_token="+CSRF_TOKEN,
...
$(document).ready(function() {
    ...
    $(".upload-widget").dropzone({
        ...
        init: function(file) {
            ...
            this.on("maxfilesexceeded", function(file) {
                ...
                if (file.previewTemplate.status == "canceled") {} else {
                    ...
                    message: 'No more files please! you can upload ' + this.options.maxFiles + ' Files <br><br>',
            ...
            this.on("sending", function(file, xhr, formData) {
                ...
                formData.append("w", $(this.element).attr('data-max-width'));

                formData.append("h", $(this.element).attr('data-max-height'));
            ...
            this.on('error', function(file, response) {
                ...
                $.fancyConfirm({
                    ...
                    message: '<strong>Error While Upload ' + file.name + ' </strong><br>' + response + '<br><br>',
            ...
            if (obj.Status == 'Error') {
                ...
                if (obj.Error) {
                 ...
                 $.fancyConfirm({
                    ...
                    message: '<strong> While Upload ' + ErrorString + ' </strong><br>' + ErrorString + '<br><br>',
                ...
                if (obj.Status == 'Success') {
                    ...
                    message: '<strong> Wrong Status<br><br>',
        ...
        /*complete:function(){
             ...
             $(file.previewTemplate).find('.dz-remove').html('<i class="ion ion-ios-close"></i>');
