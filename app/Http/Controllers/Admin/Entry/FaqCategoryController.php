...
use Validator;
use \App\Model\Entry\FaqCategory_model as WorkmModel;
...
class FaqCategoryController  extends Controller{
  ...
  public $title = 'Faq-Category';
  public $viewFolder = "entry/faqcategory";
  public $viewData = [];
  public $model = [];
  public $UserData = [];
  public $storePath = '';
  ...
  public function store(Request $request){
    ...
    $obj->faq_slug = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-',trim($request->title))));
