...
$findBlogs = blogModel::where('blog_status',1)->where('blog_type',3)->orderBy('blog_id','desc')->get();
?>
<!--header end-->
<!--hero section start-->
<!--header end-->
        ...
        <div class="card border-0 bg-transparent">
          ...
          <div class="card-body pt-5"> <a class="d-inline-block text-muted mb-2" href="<?=route('blogpage', str_replace(" ","_",$blog->blog_name))?>"><?=$blog->blog_date?></a>
            <h2 class="h5 font-weight-medium">
                <a class="link-title" href="<?=route('blogpage', str_replace(" ","-",$blog->blog_name))?>"><?php echo e($blog->blog_name); ?></a>
              </h2>
...
<!--body content end--> 
  <!--body content end-->
<!-- footer start -->
<?php echo $__env->make('layouts.frontfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/web/story-teller.blade.php ENDPATH**/ ?>