    ...
    <div class="col-12 col-lg-4 mb-6 mb-lg-0">
      ...
      <a href="<?=route('blogpage', str_replace(" ","-",strtolower($blog->blog_name)))?>">
        ...
        <div class="card border-0 bg-transparent">
          ...
          <img class="card-img-top shadow rounded" src="<?=asset('/assets/uploads/blogs/'.$blog->blog_image)?>" alt="<?php echo e($blog->image_alt); ?>">
          ...
          <div class="card-body pt-5"> <a class="d-inline-block text-muted mb-2" href="<?=route('blogpage', str_replace(" ","_",strtolower($blog->blog_name)))?>"><?=$blog->blog_date?></a>
            ...
            <h2 class="h5 font-weight-medium">
              ...
              <a class="link-title" href="<?=route('blogpage', str_replace(" ","-",strtolower($blog->blog_name)))?>"><?php echo e($blog->blog_name); ?></a>

            </h2>

            <p><?php echo serviceModel::getDesc(strip_tags($blog->blog_desc),100); ?></p>
...
<?php echo $__env->make('layouts.frontfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/web/blogs.blade.php ENDPATH**/ ?>