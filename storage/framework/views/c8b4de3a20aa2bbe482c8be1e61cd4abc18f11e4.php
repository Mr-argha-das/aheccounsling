...
<section class="shadow py-0 banner-show-desk-mb" id="booking_form">
  ...
  <div class="">
    ...
    <!----------------------------Desktop View Banner------------------------------------------>
       <?php $__currentLoopData = $bannerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banners): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     
         <div class="item owl-sld-item mob">
          <img src="<?php echo e($banners->value); ?>" class="img-fluid img-carousal" alt="banner">
          <a target="_blank" href="<?php echo e($banners->link); ?>"><button class="owl-sld-btn"> Book Now </button></a>
        </div>
 ...
 <!----------------------------Mobile View Banner------------------------------------------>
  ...
  <div class="">
    ...
    <!----------------------------Mobile View Banner------------------------------------------>
    <?php $__currentLoopData = $mobileList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banners): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <div class="item owl-sld-item mob ">
          <img src="<?php echo e($banners->value); ?>" class="img-fluid img-carousal" alt="banner">
          <a target="_blank" href="<?php echo e($banners->link); ?>"><button class="owl-sld-btn"> Book Now </button></a>
          <!-- <a target="_blank" href="<?php echo e($banners->link); ?>"><button class="owl-sld-btn1"> Book Now </button></a>
          <a target="_blank" href="<?php echo e($banners->link); ?>"><button class="owl-sld-btn2"> Book Now </button></a>
          <a target="_blank" href="<?php echo e($banners->link); ?>"><button class="owl-sld-btn3"> Book Now </button></a> -->
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="px-4 py-7 rounded hover-translate border text-center shadow">
        ...
        <div>
          ...
          <div class="ih-item square effect6 from_top_and_bottom">
            ...
            <div class="img">
              <img src="<?=asset('/assets/uploads/services/'.$service->services_image)?>" alt="<?php echo e($service->image_alt); ?>">
            </div>
         ...
         <h5 class="mt-4 mb-3"><?php echo e(serviceModel::getDesc(strip_tags($service->services_name),15)); ?></h5>

          <p><?php echo e(serviceModel::getDesc(strip_tags($service->services_desc),55)); ?>...</p>
  ...
  <div class="row">
   ...
   <div class="main-content container" id="main0">
    ...
    <div class="my-bl-carousel owl-carousel owl-theme">
      <?php $__currentLoopData = $mostProject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="item p-2">
        <div class="main-div bg-white shadow border mt-4">

         <a class="h-350 d-inline-block w-100" href="/document/<?php echo e($project->slug); ?>">
          
           <img alt="<?php echo e($project->title); ?>" class="card-img-top" loading="lazy" src="<?php echo e(asset('assets/uploads/projectthumb/'.$project->thub_img)); ?>">
        </a> 
        ...
        <div class="card-body">
          <a class="text-decoration-none" href="/document/<?php echo e($project->slug); ?>">
           ...
           <h6 class="text-black font-weight-700"><?php echo Str::limit($project->title,25); ?></h6>

           <small class="text-muted"><?php echo e($project->no_of_page); ?></small> <small class="text-muted add-dash">pages |</small>
           <small class="text-muted"><?php echo e($project->word_count); ?></small> <small class="text-muted add-dash">words |</small> 
         ...
         <p><a class="text-decoration-none" href="/document/<?php echo e($project->slug); ?>">
          <!-- <small class="text-muted btn-d-none pt-1">{ Str::limit($project->description,10) !!}</small> -->
        </a>
        <br>
        <a class="btn btn_common btn_blue btn-d-none mt-1" href="/document/<?php echo e($project->slug); ?>">View Document</a></p>
      </div>
    </div>
  </div>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="col-12">
                ...
                <div class="card p-4 shadow border-0  review-card-box">
                 ...
                 <div class="d-flex mb-3"><div class="review-img-card">
                    ...
                    <img  alt="<?php echo e($vk->image_alt); ?>" src="<?=asset('/assets/uploads/testinomials/'.$vk->test_image)?>" class="shadow-primary img-fluid rounded-circle d-inline">
...
<section class="blog">
  ...
  <div class="row bl-carousel owl-carousel owl-theme">
    ...
    <?php $__currentLoopData = $findBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="mb-6 mb-lg-0 item">
      ...
      <a href="<?=route('blogpage', str_replace(" ","-",strtolower($blog->blog_name)))?>">
        ...
        <div class="card bg-transparent blog-card-box" style="border:solid 1px rgb(218, 226, 245);border-radius:10px">
          ...
          <div class="blog-card-box-img"><img class="shadow rounded" src="<?=asset('/assets/uploads/blogs/'.$blog->blog_image)?>" alt="<?php echo e($blog->image_alt); ?>">
          </div>
          <div class="card-body pt-5"> <a class="d-inline-block text-muted mb-2" href="#"></a>

            <h2 class="h5 font-weight-medium">

              <a class="link-title" href="<?=route('blogpage', str_replace(" ","-",strtolower($blog->blog_name)))?>"><?php echo e(Str::limit($blog->blog_name, 30)); ?></a>

            </h2>

            <p><?php echo serviceModel::getDesc(trim(strip_tags($blog->blog_desc)),100); ?></p>
...
<?php /**PATH /home/agroupso/ahecounselling.com/resources/views/web/home.blade.php ENDPATH**/ ?>