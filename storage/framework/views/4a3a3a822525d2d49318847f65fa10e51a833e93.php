        ...
        <table class="table table-vcenter table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col"><b>Drop Box Api</b></th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo e($ob->drop_box_api); ?></td>
                        <td>
                                <?= Design::$dmStart ?>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/category/index.blade.php ENDPATH**/ ?>