...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #fbfbfb;color: #000000">
   ...
   <strong>Name:-    <?php echo e($booking_user_name); ?> </strong> <br>
   <strong>Email:-   <?php echo e($booking_user_email); ?></strong> <br>
   <strong>Phone:-   <?php echo e($booking_user_phone); ?></strong> <br>
   <strong>Assigment Type:- <?php echo e($subject); ?></strong> <br>
   <strong>Subject:- <?php echo e($booking_user_subject); ?></strong> <br>
   <strong>Message:- <?php echo e($booking_user_message); ?></strong> <br>
   <strong>Client Mail Subject:- <?php echo e($user_mail_subject); ?></strong> <br>
          ...
          <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <h1 class="v-font-size" style="margin: 0px; color: #274495; line-height: 210%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 38px;">
               <a href="https://www.ahecounselling.com/confirmorder/<?php echo e($table_id); ?>"> <strong> Send Approval E-mail</strong></a>
          ...
          <h3>Find blow given Attachments</h3>
</body>

</html>
<?php /**PATH /home/agroupso/ahecounselling.com/resources/views/emails/rmiduser.blade.php ENDPATH**/ ?>