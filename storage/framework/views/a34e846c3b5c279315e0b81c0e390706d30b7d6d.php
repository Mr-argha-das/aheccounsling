...
<div class="row">
         ...
         <div class="col-md-6" >
           ...
           <select   id="client_list" name="user_email" class="form-control form-control-lg"> 
               ...
               <option <?php if($orderData->en_email==$client->user_email) echo 'selected'; ?>  value="<?php echo e($client->user_email); ?>"><?php echo e($client->user_name); ?>  (<?php echo e($client->user_password); ?>)</option>
       ...
       <div class="col-md-6">
        ...
        <div class="col-md-6">
               <label class="control-label">Service Type</label>
                <select  name="en_service" id="en_service"  class="form-control form-control-lg"> 
                      <option value="">Service Type</option>
                        ...
                        <option <?php if($orderData->en_service==$key) echo 'selected'; ?> value="<?php echo e($key); ?>"><?php echo e($vs); ?> </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </select>
         </div>
         ...
         <div class="col-md-6">
           ...
           <input type="text" name="modal_en_subject" class="form-control form-control-lg" id="modal_en_subject" value="<?php echo e($orderData->en_subject); ?>"  placeholder="">
        </div>
        <div class="col-md-6">
           <label class="control-label">Module Name</label>
           <input type="text" name="modal_en_module_name" class="form-control form-control-lg" id="modal_en_module_name" value="<?php echo e($orderData->module_name); ?>"  placeholder="">
        </div>

        <div class="col-md-6">
           <label class="control-label">Deadline</label>
           <input type="text" name="deadline" class="form-control form-control-lg" id="deadline" readonly value ="<?php echo e(date('d-M-Y',strtotime($orderData->deadline))); ?>"   placeholder="">
        </div>

        <div class="col-md-6">
           <label class="control-label">Word Count</label>
           <input type="text" name="word_count" class="form-control form-control-lg numbers" id="word_count"  value="<?php echo e($orderData->word_count); ?>" placeholder="">
        </div>

        <div class="col-md-6">
           <label class="control-label">Type</label>
           <input type="text" name="assignment_type" class="form-control form-control-lg" id="assignment_type"  value="<?php echo e($orderData->assignment_type); ?>"  placeholder="Report/PPT">
        </div>
        ...
        <div class="col-md-6">
               <label class="control-label">Currency</label>
                <select  name="currency_type" id="currency_type"  class="form-control form-control-lg"> 
                      <option value="">Service Type</option>
                        ...
                        <option <?php if($orderData->currency_type==$currency->currency_id) echo 'selected'; ?> value="<?php echo e($currency->currency_id); ?>"><?php echo e($currency->currency_code); ?>(<?php echo e($currency->currency_symbol); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </select>
         </div>
          ...
          <div class="col-md-6">
           ...
           <input type="text" name="client_amount" class="form-control form-control-lg" id="client_amount"  value="<?php echo e($orderData->client_amount); ?>"  placeholder="Client amount">
        </div>

        <div class="col-md-6">
           <label class="control-label">INR Amount</label>
           <input type="text" name="inr_amount" class="form-control form-control-lg" id="inr_amount"  value="<?php echo e($orderData->inr_amount); ?>"  placeholder="INR amount">
        </div>

        <div class="col-md-6">
           <label class="control-label">AUD Amount</label>
           <input type="text" name="aud_amount" class="form-control form-control-lg" id="aud_amount"  value="<?php echo e($orderData->aud_amount); ?>"  placeholder="AUD amount">
        </div>
       ...
       <div class="col-md-12">
         ...
         <textarea id="modal_en_query" class="form-control form-control-lg" name="modal_en_query" rows="5" placeholder=""><?php echo e($orderData->modal_en_query); ?></textarea>
     </div>
       <div class="col-md-6">
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/orders/copycreate.blade.php ENDPATH**/ ?>