            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo e($ob->about_name); ?></td>
               
                           <td><?php if(!empty($ob->about_image)){ ?>
                            <img src="<?php echo e(asset('assets/uploads/aboutus/'.$ob->about_image)); ?> " width="60" width="60">
                            <?php } ?></td>

                            <td><?php echo e($statusDropdown[$ob->about_status]); ?></td>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/aboutus/index.blade.php ENDPATH**/ ?>