...
<script src="<?php echo e(asset('webassets/js/chart/accessibility.js')); ?>"></script>
 ...
 $( document ).ready(function() {
  ...
  $.ajax({
      'async': false,
      'global': false,
       url: "<?php echo e(route('getAdminData')); ?>",
       dataType: 'json',
       type: 'get',
       data: { id:1},
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/dashboard/adminindex.blade.php ENDPATH**/ ?>