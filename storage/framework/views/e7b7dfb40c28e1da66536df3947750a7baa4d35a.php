        ...
        <?php
         ...
         ?>
              ...
              <ul class="navbar-nav list-unstyled mb-0">
                  ...
                  <li class="mb-3 nav-item"><a class="nav-link" href="<?=route('servicespage', str_replace(" ","-",strtolower($service->services_name)))?>"><?php echo e($service->services_name); ?></a>
                  </li>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
 ...
 </html><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/layouts/frontfooter.blade.php ENDPATH**/ ?>