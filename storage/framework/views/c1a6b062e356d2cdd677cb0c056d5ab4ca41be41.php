            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo e($ob->test_name); ?></td>
               
                        <td><?php if(!empty($ob->test_image)){ ?>
                            <img src="<?php echo e(asset('assets/uploads/testinomials/'.$ob->test_image)); ?> " width="60" width="60">
                            <?php } ?></td>

                         <td><?php echo $ob->test_desc; ?></td>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/testinomials/index.blade.php ENDPATH**/ ?>