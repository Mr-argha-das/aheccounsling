    ...
    <div class="block-content">
        <table class="table table-vcenter table-hover">
            <thead>
                <tr>
                    <th scope="col"><b>#</b></th>
                    <th scope="col"><b>PHP Key</b></th>
                    <th scope="col"><b>Title</b></th>
                    <th scope="col"><b>Value</b></th>
                    <th scope="col"><b>Access Type</b></th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                       <td><?= $sr++ ?></tD>
                       <td><?php echo e($ob->setting_var); ?></td>
                      <td><?php echo e($ob->setting_name); ?></td>
                      <td><?php echo e($ob->setting_value); ?></td>
                      <td><?php echo e($loginUsers[$ob->setting_access]); ?></td>
                      <td><?php echo e($ob->setting_sorting); ?></td>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/settings/index.blade.php ENDPATH**/ ?>