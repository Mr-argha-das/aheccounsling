...
<script type="application/ld+json">
  {
    ...
    "articleSection": "<?php echo e($row->services_name); ?>",
    "description": "<?php echo e($seoDesc); ?>"  }
  </script>
...
<section>
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="card border-0 bg-transparent">
          ...
          <img class="card-img-top shadow rounded" src="<?=asset('/assets/uploads/services/'.$row->services_image)?>"  alt=" <?php echo e($row->services_name); ?>">
          ...
          <a href="<?php echo e($whatsAppLink); ?>"><button class="w-100 bg-success text-white px-5 py-3 border-0 mb-2 mt-2">Click on Whatsapp</button></a>
  ...
  <div class="card">
    <div class="card-header pointer" data-toggle="collapse" data-target="#collapse-<?php echo e($key); ?>">
 ...
 ?>
            ...
            <div class="item">
              ...
              <div class="card border-0 bg-transparent m-4">
                ...
                <a class="link-title" href="<?=route('servicespage', str_replace(" ","-",strtolower($blog->services_name)))?>"><?php echo e($blog->services_name); ?></a>

              </h2>

                  <p><?php echo e(serviceModel::getDesc($blog->blog_desc,100)); ?></p>
...
<?php echo $__env->make('layouts.frontfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/web/singleservices.blade.php ENDPATH**/ ?>