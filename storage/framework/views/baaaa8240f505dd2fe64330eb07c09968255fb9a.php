...
<div class="row">
      <div class="col-md-12 ">
           <?php echo e(Form::bsText('blog_name',$row->blog_name,['label'=>$niceNames,'class'=>'form-control'])); ?>
       ...
       <div class="col-md-12 ">
        ...
        <div class="col-md-12 ">
           <?php echo e(Form::bsText('youTubeLink',$row->youTubeLink,['label'=>'youTubeLink ID','class'=>'form-control'])); ?>

       </div>
          <div class="col-md-12 ">
           <?php echo e(Form::bsText('order_number',$row->order_number,['label'=>'order Number','class'=>'form-control'])); ?>

       </div>
      <div class="col-md-12 ">
           <?php echo e(Form::bsTextarea('blog_desc',$row->blog_desc,['label'=>$niceNames,'class'=>'form-control ckeditor'])); ?>
       ...
       <div class="col-md-12 ">
         ...
         <div class="col-md-12 ">
           <?php echo e(Form::bsSelect('blog_status',$statusDropdown,$row->blog_status,['label'=>$niceNames,'class'=>'form-control'])); ?>

       </div>
         <div class="col-md-12 ">
           <?php echo e(Form::bsSelect('blog_comment',$statusDropdown,$row->blog_comment,['label'=>$niceNames,'class'=>'form-control'])); ?>

       </div>

        <div class="col-md-12 ">
           <?php echo e(Form::bsText('seo_tilte',$row->seo_tilte,['label'=>'Seo tilte','class'=>'form-control'])); ?>
        ...
        <div class="col-md-12 ">
           <?php echo e(Form::bsText('seo_description',$row->seo_description,['label'=>"Seo description",'class'=>'form-control'])); ?>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/blogs/edit.blade.php ENDPATH**/ ?>