            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo e($ob->y_title); ?></td>
               
                        <td>
                            <a data-fancybox href=<?php echo e($ob->y_url); ?>" class="btn btn-primary"><i class="si si-youtube"></i>
    Play Video
</a>
                        </td>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/videogallery/index.blade.php ENDPATH**/ ?>