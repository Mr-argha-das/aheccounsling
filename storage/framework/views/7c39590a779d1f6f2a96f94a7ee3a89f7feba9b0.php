...
<div class="row">
         <div class="col-md-6 d-none" >
           ...
           <select   id="client_list" name="user_email" class="form-control form-control-lg"> 
               ...
               <option  <?php if($client->user_email==$edit_data->en_email){ echo 'selected'; } ?> value="<?php echo e($client->user_email); ?>"><?php echo e($client->user_name); ?>  (<?php echo e($client->user_password); ?>)</option>
               ...
               <label class="control-label">Service Type</label>
                <select  name="en_service" id="en_service"  class="form-control form-control-lg" required> 
                      <option value="">Service Type</option>
                        ...
                        <option <?php if($edit_data->en_service==$key){ echo 'selected'; } ?> value="<?php echo e($key); ?>"><?php echo e($vs); ?> </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </select>
         </div>
      ...
      <!--  <div class="col-md-6">
          ...
          <select    name="rm_id" id="rm_id_select2"  class="form-control form-control-lg" required>
            ...
            <option <?php if($edit_data->rm_id==$rm_id){  echo 'selected'; } ?> value="<?php echo e($rm_id); ?>"><?php echo e($rmusername); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div> -->
               ...
               <label class="control-label">Currency</label>
                <select  name="currency_type" id="currency_type"  class="form-control form-control-lg"> 
                      <option value="">Service Type</option>
                        ...
                        <option <?php if($edit_data->currency_type==$currency->currency_id){ echo 'selected'; } ?> value="<?php echo e($currency->currency_id); ?>"><?php echo e($currency->currency_code); ?>(<?php echo e($currency->currency_symbol); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </select>
         </div>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/orders/edit.blade.php ENDPATH**/ ?>