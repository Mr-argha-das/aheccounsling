...
<head>
    ...
    <title><?php echo e($title); ?> | AHEC</title>
    ...
    <script src="<?php echo e(asset('webassets/js/jquery-3.5.1.js')); ?>"></script>

    <script src="<?php echo e(asset('webassets/js/jquery.validate.min.js')); ?>"></script>

    <script src="<?php echo e(asset('admin/assets/ckeditor/ckeditor.js')); ?>"></script>



    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('webassets/css/dropzone.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('webassets/css/dropzone.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('webassets/css/jquery.dataTables.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('webassets/css/buttons.bootstrap4.min.css')); ?>">

     

     <script src="<?php echo e(asset('webassets/js/jquery.dataTables.min.js')); ?>"></script>

     <script src="<?php echo e(asset('webassets/js/dataTables.buttons.min.js')); ?>"></script>

     <script src="<?php echo e(asset('webassets/js/jszip.min.js')); ?>"></script>

     <script src="<?php echo e(asset('webassets/js/buttons.html5.min.js')); ?>"></script>
...

                                   {
                                    ...
                                    foreach ($drodlist as $key => $ls) { ?>
                                        ...
                                        <li class="nav-main-item">
                                                ...
                                                <a class="nav-main-link" href="<?php echo e($ls->nv_url); ?>">

                                                    <span class="nav-main-link-name"><?php echo e($ls->nv_name); ?></span>
                ...
                <div>
                    ...
                    <div id="error_notification">
                        ...
                        <div class="flash-message">
                            ...
                            <?php $__currentLoopData = ['s'=>'success', 'w'=>'warning', 'd'=>'danger', 'i'=>'info']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</script><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/layouts/backend.blade.php ENDPATH**/ ?>