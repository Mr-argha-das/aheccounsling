            ...
            <div class="flex-sm-fill">
              ...
              <div class="flex-sm-00-auto mt-3 mt-sm-0 ml-sm-3">
                    <span class="d-inline-block js-appear-enabled animated fadeIn" data-toggle="appear" data-timeout="350">
                     ...
                     <!--  <span class="d-inline-block js-appear-enabled animated fadeIn" data-toggle="appear" data-timeout="350">
                        <a target="_blank" class="btn btn-primary" href="<?php echo e(url('admin/entry/myclientorders/excelfile/'.$rm_id)); ?>"><i class="fa fa-download mr-1"></i>CSV file</a>
                    </span> -->
                </div>
        </div>
    </div>
...
<div class="col-md-4 ">
 ...
 <div class="col-md-4 ">
  ...
  <input type="hidden" value="<?php echo e($rm_id); ?>" name="rm_id">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <!-- <td>+<?php echo e($ob->phone_code.' '.$ob->en_mobile); ?></td> -->
                        <td><?php echo e($ob->services_name); ?></td>
                        <!--    <td><?php echo e($ob->en_subject); ?></td>
                        <td><?php echo e($ob->en_query); ?></td> -->
                        
            <td>
                <?php if(!empty($ob->Screenshot)){
                    ?>
                    <a href="<?php echo e(asset('assets/uploads/enquiry/'.$ob->Screenshot)); ?>" target="_blank" class="btn btn-primary btn-sm">View Screenshot </a>
                ...
                ?>
                 ...
                 <td>
                  ...
                  <a class="fancyboxajax" href="<?php echo e(url('admin/entry/myclientorders/'.$rowId.'/edit')); ?>">Update Status</a>
                   <?php if($ob->order_type==1): ?>
                  <a class="fancyboxajax" href="<?php echo e(url('admin/entry/myclientorders/copyorder/'.$rowId)); ?>">Copy Order</a>
                   <?php endif; ?>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/orders/myclientsorder.blade.php ENDPATH**/ ?>