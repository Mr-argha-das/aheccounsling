            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo e($ob->rmid); ?></td>
                        <td><?php echo e($ob->name); ?></td>
                        <td><?php echo e($ob->email); ?></td>
                        <td><?php echo e($ob->phone); ?></td>
                        <td><?php echo e($ob->symbol); ?></td>
                        <td><?php echo e($statusDropdown[$ob->status]); ?></td>
                        <td>
                            <?= Design::$dmStart ?>
...
<?php echo $__env->make('layouts.'.config('backendLayout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/agroupso/ahecounselling.com/resources/views/admin/entry/rmiduser/index.blade.php ENDPATH**/ ?>